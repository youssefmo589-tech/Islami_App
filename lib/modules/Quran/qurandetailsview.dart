...
//
//
//    if(verses.isEmpty) readfromfile() ;
//
//    SuraDatamodel sura =
...
//                   Text(sura.suraNameAR , style: TextStyle(fontSize: 24 , fontWeight: FontWeight.w700 , color: AppColors.gold , fontFamily: "Janna"),) ,
...
//                   return Text(verses[index] , style: TextStyle(
//                     fontSize: 20 , fontWeight: FontWeight.w700 , fontFamily: "Janna" ,
...
// {
//  String content =  await rootBundle.loadString("assets/files/Quran/1.txt") ;
